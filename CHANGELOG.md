...
### Released
- Shipped **classroom-ai-aup-landing** as a public artifact for teams dealing with education operations.
...
### Shipped
- Cut the first coherent internal version of **classroom-ai-aup-landing** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: Landing site for the Classroom AI AUP spec. Live at aup.kineticgain.com.
- Focused the repo around actionability instead of passive reporting.

## [Prototype] - 2025-09-17
